Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/ahaseebchina02/PredictIOPod.git'
  ...
  s.source           = { :git => 'https://github.com/ahaseebchina02/PredictIOPod.git', :tag => s.version.to_s }
 ...
 s.vendored_library = 'PredictIOPod/libPredictIO.a'
